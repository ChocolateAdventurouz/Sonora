...
/// <summary>
/// Processes audio through VST
/// </summary>
internal class VstAudioProcessor
{
    ...
    private void ProcessBuffer(int blockSize)
    {
    ...
    private void UpdateBlockSize(int blockSize)
    {
        ...
        _vstPlugin.PluginContext.PluginCommandStub.Commands.SetSampleRate(SonoraMain.SampleRate);
