...
/// <summary>
/// Core class of the Sonora framework.
/// </summary>
public static class SonoraMain
{
    private static bool _initialized;

    /// <summary>
    /// Sample Rate used by the Sonora framework
    /// </summary>
    public static int SampleRate { get; private set; } = 44100;

    /// <summary>
    /// The <see cref="AudioDevice"/> used by the Sonora framework.
    /// </summary>
    ...
    /// <summary>
    /// The <see cref="global::Sonora.MidiInputDevice"/> used by the Sonora framework.
    /// </summary>
    ...
    /// <summary>
    /// Event fired when the Sonora framework <see cref="AudioDevice"/> is changed.
    /// </summary>
    internal static event EventHandler<AudioDeviceChangedEventArgs> AudioDeviceChanged;

    /// <summary>
    /// Event fired when the Sonora framework <see cref="global::Sonora.MidiInputDevice"/> is changed.
    /// </summary>
    internal static event EventHandler<MidiDeviceChangedEventArgs> MidiDeviceChanged;

    /// <summary>
    /// Initialize the Sonora framework.
